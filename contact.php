			...
			<article class="col-sm-9 maincontent">
				...
				<br>
					<form action="contact.php" method="post">
						...
						<div class="row">
							<div class="col-sm-12">
								<textarea placeholder="Type your message here..." class="form-control" name="msg" rows="9" required></textarea>
							</div>
						</div>
						<br>
						<div class="row">
...
$sql = "INSERT INTO `GLV`.`contact` (`id`, `nom`, `email`, `phone`, `message`) VALUES ('', '$nom','$email','$phone','$msg')";
