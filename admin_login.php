...
$sqladmin = mysqli_query($conn,"SELECT login,password FROM admin WHERE login='$login' AND password='$password'");

if(isset($_POST['submit'])){


if(mysqli_fetch_row($sqladmin))
{
			...
			echo "<script type='text/javascript' language='javascript'>
             var temp = 'Login & Password Erreur !'
            alert(temp)
            </script>";
}
}
...
<title>Location Progressus</title>
...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="index.html"><img src="assets/images/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
