...
<form action="offerdetails_left.php" method="POST">

<p>Garage Reservation :</p>
                               <!-- ville de depart -->
					          <input list="browsers" name="browser" placeholder="garage d'emprunt">
...
?>	
                              ...
                              <!-- ville de retour -->
                       <!--       <input list="browsers" name="browser" placeholder="garage de restitution">
                              <datalist id="browsers">
			...
			<article class="col-md-8 maincontent">
				...
				<img src="<?php echo $row["image"]?>" alt="" class='td_image'>
				 <table class=''>
				       ...
				       <tr>
				       <td align="center"> 
				       <?php echo "<a href=offerdetails_left.php?id_v=".$id_v."&id_c=".$id_c.">"; 
                       echo " <img src='assets/images/button_res.png' width=160 height=60 alt= >";
                       echo "</a>";
                       ?>
			    	   </td>
				       </tr>
