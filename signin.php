...
$sqladmin = mysqli_query($conn,"SELECT cin,password FROM client WHERE cin='$cin' AND password='$password'");
						...
						<div class="panel-body">
							...
							<form action="signin.php" method="GET">
								<div class="top-margin">
									<label>CIN/Email <span class="text-danger">*</span></label>
								...
								<div class="row">
									...
									<div class="col-lg-4 text-right">
										<input class="btn btn-action" type="submit" name="submit" ></input>
									</div>
								</div>
							</form>
						</div>
